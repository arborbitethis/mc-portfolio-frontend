...
const RecipePage = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <p className='text-center text-lg text-gray-600'>Please note that these are currently fake placeholder recipes generated by GPT-4 and should not be trusted!</p>
      {!selectedRecipe && (
        <Filters
